...
data class Providers(val ethereum: String, val goerli: String, val sepolia: String, val polygon: String, val mumbai: String, val astar: String, val moonbeam: String, val opal: String, val unique: String, val kai: String)

data class ChainConfig(val providers: Providers, val privateKey: String)

data class KeysConfig(val keys: Map<String, String>)

data class ApiKeys(val ethereumBlockExplorer: String, val polygonBlockExplorer: String, val alchemy: String, val nftstorage: String, val subscan: String, val kaiindexer: String)
...
object WaltIdServices {
    ...
    fun getBlockExplorerUrl(chain: EVMChain): String {
        return when (chain) {
            ...
            EVMChain.KAI -> Values.KAI_MAINNET_BLOCK_EXPLORER_URL
